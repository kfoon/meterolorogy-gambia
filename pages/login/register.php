...
<link href="./pages/login/css/layout.css" rel="stylesheet" type="text/css">
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
  <tr> 
   <div id="header">
			<h1>Advance Hospital Management System
			</h1><h2>In and Out Patient Maintenance Module.</h2>
		</div>
  </tr>
...
<td width="160" valign="top">
  ...
  <a href="login.php?p=myaccount">My Account</a><br>
  <a href="login.php?p=mysettings">Settings</a><br>
  <a href="login.php?p=logout">Logout </a>
  <p>You can add more links here for users</p></div>
      <p> <a href="login.php?p=admin">Admin CP </a></p>
	        <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp; </p>
	...
	<?php 
	 if (isset($_GET['done'])) { ?>
	  <h2>Thank you</h2> Your registration is now complete and you can <a href="login.php?p=login">login here</a>";
	 <?php exit();
	  }
	?>
	 ...
	 ?> 
      ...
      <p align="right"><span style="font: normal 9px verdana">Powered by <a href="#">PHP 
                 </a></span></p>
