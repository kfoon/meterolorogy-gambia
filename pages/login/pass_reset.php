...
<link href="./pages/login/css/login2.css" rel="stylesheet" type="text/css">
<link href="./pages/login/css/login3.css" rel="stylesheet" type="text/css">
<link href="./pages/login/css/login4.css" rel="stylesheet" type="text/css">
<link href="./pages/login/css/login6.css" rel="stylesheet" type="text/css">
...
<a title="Go to superTech Home" href="/" class="lfloat"><role="button" class="signup_btn uiButton uiButtonSpecial uiButtonLarge">
<span class="uiButtonText">Advance Hospital Management System </span></role="button"></a>

<h1 style="margin-top:3px"></h1><div class="rfloat"></div></div></div>
 <div class="signup_bar_container">
<div class="signup_box clearfix">
<a class="signup_btn uiButton uiButtonSpecial uiButtonLarge" role="button" href="">
<span class="uiButtonText">Need Help?</span></a><span class="signup_box_content">
...
<style type="text/css">
    ...
    <div style="margin: 5px 0; text-align: left; clear:both;">
     <a href="#"><img src="pages/login/images/logo.png" width="158" height="51" /></a>

    </div>

<div id="logins">
   <form action="login.php?p=forgot" id="signin_standard" method="post" name="signin_gmail" onsubmit="MM.ui.disableButton('btn_signin');" style="display:none">
  ...
  <form action="login.php?p=login" id="signin_gmail" method="post" name="signin_standard" onsubmit="MM.ui.disableButton('btn_signin');">
      ...
      <div class="content" style="height:110px;">
        ...
        <div style="width:0; height:0; overflow: ;">
          <input name="doLogin" type="submit" value="Login" class="button default" id="btnLogin" style="font-size:17px; float:left" tabindex="3"  />
...
<script type="text/javascript">
    Object.extend(
        ...
        buildLoginPopover: function() {
            ...
            var elements = [];
            elements.push((new Element('a', {href: '#', id: 'standard_login', onclick: 'return MM.ui.switchLoginType("gmail")'})).update('Login'));
            //elements.push((new Element('a', {href: '#', id: 'unilogin_login', onclick: 'return MM.ui.switchLoginType("unilogin")'})).update('Unilogin'));

            elements.push((new Element('a', {href: '#', id: 'gmail_login', onclick: 'return MM.ui.switchLoginType("standard", "standard")'})).update('Reset Password'));
