...
<link href="./pages/login/css/styles.css" rel="stylesheet" type="text/css"></head>
...
<h3 class="titlehdr">Forgot Password</h3>
	...
	if(!empty($err))  {
      ...
      <form action="login.php?p=pass_reset" method="post" name="actForm" id="actForm" >
        <table width="65%" border="0" cellpadding="4" cellspacing="4" class="loginform">
          ...
          <tr> 
            <td colspan="2"> <div align="center"> 
                <p> 
                  <input name="doReset" type="submit" id="doLogin3" value="Reset" class="buttons">
                </p>
              </div></td>
          </tr>
        </table>
