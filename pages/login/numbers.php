...
mysql_query("INSERT INTO allow (`mobile`)
			 VALUES ('$post[mobile]')
			 ") or die(mysql_error());
...
$mobile = $post['mobile'];
//echo "<div class=\"msg\">$mobile succesfully added.....Done</div>";
}
 ...
 <form action="" method="post" name="myform" id="myform">
        <table width="90%" border="0" align="center" cellpadding="3" cellspacing="3" class="">
          ...
          <tr>
            ...
            <td width="73%"><input name="mobile" type="text"  class="required"  value="<?php echo $data_row[mobile];?>"></td>
          </tr>
...
<input name="doSubmit" type="submit" class="buttons" id="doSubmit" value="Create">
	...
	$tbl_name="allow";		//your table name
	...
	*/
	...
	$targetpage = "login.php?p=number"; 	//your file name  (the name of this file)
...
echo '<div class="subHeading"><h3>Number List</h3></div>';
