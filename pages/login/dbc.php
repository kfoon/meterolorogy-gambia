...
define ("DB_NAME","weather"); // set database name
...
function checkUser() {
if($_SESSION["user_level"]== USER_LEVEL||$_SESSION["user_level"]==ADMIN_LEVEL ||$_SESSION["user_level"]==VADMN_LEVEL) {
return 1;
} else { return 0 ;
}
}
...
if($_SESSION['user_level'] == GUEST_LEVEL) {
return 1;
} else { return 0 ;
}
}
